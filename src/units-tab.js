...
import { buildUnit, preloadMkcx, makeDebris, makeDotBurst, makeBulletCloud,
  ...
  preloadFabricator, makeFabricatorDrone } from './units.js?v=7f948aa3';
import { TANK_FEEL, TANK_FEEL_KNOBS, formatFeelCode, makeTankFeel, stepTankFeel,
  landTankFeel, fireTankFeel, applyTankFeel, applyTankHealth } from './tankfeel.js?v=7f948aa3';
import { FEEL, loadFeel, saveFeel, resetFeel,
  TOWER, HEADS, loadTower, saveTower, resetTower } from './feelstore.js?v=7f948aa3';
import { TOWER_FEEL_KNOBS, formatTowerFeel, clampTowerParams,
  formatTowerHeads, HEAD_CHOICES, HEAD_AS_SHIPPED } from './towerfeel.js?v=7f948aa3';
import { CREATURE_TINTS } from './enemyspec.js?v=7f948aa3';
...
import { FONT_NAMES, TYPE_KNOBS, TYPE_FEEL, makeTypeParams, clampTypeParams,
  formatTypeCode, applyFontPack, currentFontPack, currentShoutPack } from './fonts.js?v=7f948aa3';
import { LORE, LORE_WORLD, loreText, loreAll } from './lore.js?v=7f948aa3';
