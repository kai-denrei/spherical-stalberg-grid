...
import { buildUnit, preloadMkcx, makeDebris, makeDotBurst, makeBulletCloud,
  ...
  preloadFabricator, makeFabricatorDrone, makeIsaoDrone } from './units.js?v=9f3127ff';
import { TANK_FEEL, TANK_FEEL_KNOBS, formatFeelCode, makeTankFeel, stepTankFeel,
  landTankFeel, fireTankFeel, applyTankFeel, applyTankHealth } from './tankfeel.js?v=9f3127ff';
import { FEEL, loadFeel, saveFeel, resetFeel,
  TOWER, HEADS, loadTower, saveTower, resetTower } from './feelstore.js?v=9f3127ff';
import { TOWER_FEEL_KNOBS, formatTowerFeel, clampTowerParams,
  formatTowerHeads, HEAD_CHOICES, HEAD_AS_SHIPPED } from './towerfeel.js?v=9f3127ff';
import { CREATURE_TINTS, accentFor } from './enemyspec.js?v=9f3127ff';
import { buildTowerLook, TOWER_LOOK_NAMES, DEFAULT_TOWER_LOOK, preloadLook } from './towerlooks.js';
import { TOWER_BY_KEY, TOWERS } from './towers.js?v=9f3127ff';
...
import { FONT_NAMES, TYPE_KNOBS, TYPE_FEEL, makeTypeParams, loadTypeFeel, saveTypeFeel,
  formatTypeCode, applyFontPack, currentFontPack, currentShoutPack } from './fonts.js?v=9f3127ff';
import { LORE, LORE_WORLD, loreText, loreAll } from './lore.js?v=9f3127ff';
