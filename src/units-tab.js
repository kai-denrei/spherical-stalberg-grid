...
import { buildUnit, preloadMkcx, makeDebris, makeDotBurst, makeBulletCloud,
  ...
  preloadFabricator, makeFabricatorDrone, makeIsaoDrone } from './units.js?v=4571a1c6';
import { TANK_FEEL, TANK_FEEL_KNOBS, formatFeelCode, makeTankFeel, stepTankFeel,
  landTankFeel, fireTankFeel, applyTankFeel, applyTankHealth } from './tankfeel.js?v=4571a1c6';
import { FEEL, loadFeel, saveFeel, resetFeel,
  TOWER, HEADS, loadTower, saveTower, resetTower } from './feelstore.js?v=4571a1c6';
import { TOWER_FEEL_KNOBS, formatTowerFeel, clampTowerParams,
  formatTowerHeads, HEAD_CHOICES, HEAD_AS_SHIPPED } from './towerfeel.js?v=4571a1c6';
import { CREATURE_TINTS, accentFor } from './enemyspec.js?v=4571a1c6';
...
import { FONT_NAMES, TYPE_KNOBS, TYPE_FEEL, makeTypeParams, loadTypeFeel, saveTypeFeel,
  formatTypeCode, applyFontPack, currentFontPack, currentShoutPack } from './fonts.js?v=4571a1c6';
import { LORE, LORE_WORLD, loreText, loreAll } from './lore.js?v=4571a1c6';
