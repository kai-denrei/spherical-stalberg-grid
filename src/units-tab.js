...
import { buildUnit, preloadMkcx, makeDebris, makeDotBurst, makeBulletCloud,
  ...
  preloadFabricator, makeFabricatorDrone, makeIsaoDrone } from './units.js?v=2b9095d2';
import { TANK_FEEL, TANK_FEEL_KNOBS, formatFeelCode, makeTankFeel, stepTankFeel,
  landTankFeel, fireTankFeel, applyTankFeel, applyTankHealth } from './tankfeel.js?v=2b9095d2';
import { FEEL, loadFeel, saveFeel, resetFeel,
  TOWER, HEADS, loadTower, saveTower, resetTower } from './feelstore.js?v=2b9095d2';
import { TOWER_FEEL_KNOBS, formatTowerFeel, clampTowerParams,
  formatTowerHeads, HEAD_CHOICES, HEAD_AS_SHIPPED } from './towerfeel.js?v=2b9095d2';
import { CREATURE_TINTS, accentFor } from './enemyspec.js?v=2b9095d2';
import { buildTowerLook, TOWER_LOOK_NAMES, DEFAULT_TOWER_LOOK, preloadLook } from './towerlooks.js';
import { TOWER_BY_KEY, TOWERS } from './towers.js?v=2b9095d2';
...
import { FONT_NAMES, TYPE_KNOBS, TYPE_FEEL, makeTypeParams, loadTypeFeel, saveTypeFeel,
  formatTypeCode, applyFontPack, currentFontPack, currentShoutPack } from './fonts.js?v=2b9095d2';
import { LORE, LORE_WORLD, loreText, loreAll } from './lore.js?v=2b9095d2';
