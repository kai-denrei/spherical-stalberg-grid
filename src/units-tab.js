...
import { buildUnit, preloadMkcx, makeDebris, makeDotBurst, makeBulletCloud,
  ...
  preloadFabricator, makeFabricatorDrone, makeIsaoDrone } from './units.js?v=a1b5f2a0';
import { TANK_FEEL, TANK_FEEL_KNOBS, formatFeelCode, makeTankFeel, stepTankFeel,
  landTankFeel, fireTankFeel, applyTankFeel, applyTankHealth } from './tankfeel.js?v=a1b5f2a0';
import { FEEL, loadFeel, saveFeel, resetFeel,
  TOWER, HEADS, loadTower, saveTower, resetTower } from './feelstore.js?v=a1b5f2a0';
import { TOWER_FEEL_KNOBS, formatTowerFeel, clampTowerParams,
  formatTowerHeads, HEAD_CHOICES, HEAD_AS_SHIPPED } from './towerfeel.js?v=a1b5f2a0';
import { CREATURE_TINTS, accentFor } from './enemyspec.js?v=a1b5f2a0';
...
import { FONT_NAMES, TYPE_KNOBS, TYPE_FEEL, makeTypeParams, loadTypeFeel, saveTypeFeel,
  formatTypeCode, applyFontPack, currentFontPack, currentShoutPack } from './fonts.js?v=a1b5f2a0';
import { LORE, LORE_WORLD, loreText, loreAll } from './lore.js?v=a1b5f2a0';
