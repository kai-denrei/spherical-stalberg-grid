...
import { UNITS, UNIT_NAMES, buildUnit, buildCreature, onMkcxReady, makeOrbCloud, makeBulletCloud, makeDebris, makeDotBurst, makePortalCloud, makeHeartCloud } from './units.js?v=3dd0aa59';
import { LOOKS, LOOK_NAMES } from './looks.js?v=3dd0aa59';
import { makeCellIndex } from './cellindex.js?v=3dd0aa59';
import { CREATURE_TINTS, ENEMY_SPEC, INTROS } from './enemyspec.js?v=3dd0aa59';
