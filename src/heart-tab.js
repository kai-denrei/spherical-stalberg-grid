...
import { UNITS, UNIT_NAMES, buildUnit, buildCreature, onMkcxReady, makeOrbCloud, makeBulletCloud, makeDebris, makeDotBurst, makePortalCloud, makeHeartCloud } from './units.js?v=c492851f';
import { LOOKS, LOOK_NAMES } from './looks.js?v=c492851f';
import { makeCellIndex } from './cellindex.js?v=c492851f';
import { CREATURE_TINTS, ENEMY_SPEC, INTROS } from './enemyspec.js?v=c492851f';
