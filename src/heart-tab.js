...
import { UNITS, UNIT_NAMES, buildUnit, buildCreature, onMkcxReady, makeOrbCloud, makeBulletCloud, makeDebris, makeDotBurst, makePortalCloud, makeHeartCloud } from './units.js?v=7fcd1afb';
import { LOOKS, LOOK_NAMES } from './looks.js?v=7fcd1afb';
import { makeCellIndex } from './cellindex.js?v=7fcd1afb';
import { CREATURE_TINTS, ENEMY_SPEC, INTROS } from './enemyspec.js?v=7fcd1afb';
