...
import { createPlanetTankGame, DYING_T } from './tanks2.js?v=991ddfda';
import { buildUnit, onMkcxReady, makeBulletCloud, makeDebris } from './units.js?v=991ddfda';
import { LOOKS } from './looks.js?v=991ddfda';
import { mulberry32 } from './rng.js?v=991ddfda';
import { norm3, scale3 } from './vec3.js?v=991ddfda';
