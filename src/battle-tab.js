...
import { generateDungeon, BLOCKED, PATH, ROOM } from './dungeon.js?v=ecdcaf95';
...
import { UNITS, UNIT_NAMES, buildUnit, buildCreature, onMkcxReady, makeOrbCloud, makeBulletCloud, makeDebris, ORB_FX, makeHeartCloud } from './units.js?v=ecdcaf95';
