...
import { installCine } from './cine/kit.js?v=b0473f12';
import { createGate } from './cine/gate.js?v=b0473f12';
import { rateFromSample, fitSize, marchBudgetMs, createGovernor } from './cine/governor.js?v=b0473f12';
