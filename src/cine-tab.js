...
import { installCine } from './cine/kit.js?v=9885c97b';
import { createGate } from './cine/gate.js?v=9885c97b';
import { rateFromSample, fitSize, marchBudgetMs, createGovernor } from './cine/governor.js?v=9885c97b';
