...
import { installCine } from './cine/kit.js?v=17f42c04';
import { createGate } from './cine/gate.js?v=17f42c04';
import { rateFromSample, fitSize, marchBudgetMs, createGovernor } from './cine/governor.js?v=17f42c04';
