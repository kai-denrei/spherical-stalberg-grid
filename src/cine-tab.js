...
import { installCine } from './cine/kit.js?v=06963fb0';
import { createGate } from './cine/gate.js?v=06963fb0';
import { rateFromSample, fitSize, marchBudgetMs, createGovernor } from './cine/governor.js?v=06963fb0';
