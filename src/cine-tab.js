...
import { installCine } from './cine/kit.js?v=9032cb00';
import { createGate } from './cine/gate.js?v=9032cb00';
import { rateFromSample, fitSize, marchBudgetMs, createGovernor } from './cine/governor.js?v=9032cb00';
