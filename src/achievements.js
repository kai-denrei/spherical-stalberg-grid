...
export const ACHIEVEMENTS = [
  ...
  { id: 'nohands', name: 'DESK OFFICER', group: 'combat',
    note: 'banked a tour without a single hands-on kill. the towers did it all',
    test: (s) => s.tourBanked && s.tankKills === 0 },

  // --- campaign ------------------------------------------------------------
  { id: 'surveyed', name: 'SURVEYED AND HELD', group: 'campaign',
    note: 'banked a tour. fifteen waves, and you walked away with it',
    test: (s) => s.tourBanked },
  { id: 'kkill0', name: 'K-KILL 0', group: 'campaign',
    note: 'banked a tour without losing a single hull',
    test: (s) => s.tourBanked && s.hullsLost === 0 },
  { id: 'iloveyou', name: 'I LOVE YOU', group: 'campaign',
    note: 'banked a tour with the Heart untouched. it beat sixty the whole way',
    test: (s) => s.tourBanked && s.heartHits === 0 },
  { id: 'doubleornothing', name: 'DOUBLE OR NOTHING', group: 'campaign',
    note: 'pressed on with a clear in the pot, and survived the next tour',
    test: (s) => s.tourBanked && s.toursCleared >= 2 },
