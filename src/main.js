...
import { wireDevlogBadge } from './devlog.js?v=1663e0b3';
import { initGridTab } from './grid-tab.js?v=1663e0b3';
import { initMazeTab } from './maze-tab.js?v=1663e0b3';
import { initOrganicTab } from './organic-tab.js?v=1663e0b3';
import { initHowTab } from './how-tab.js?v=1663e0b3';
