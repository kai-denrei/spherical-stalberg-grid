...
import { wireDevlogBadge } from './devlog.js?v=049a422d';
import { initHomeTab } from './home-tab.js?v=049a422d';
import { initGridTab } from './grid-tab.js?v=049a422d';
import { initMazeTab } from './maze-tab.js?v=049a422d';
import { initOrganicTab } from './organic-tab.js?v=049a422d';
import { initBattleTab } from './battle-tab.js?v=049a422d';
import { initHeartTab } from './heart-tab.js?v=049a422d';
import { initTdTab } from './td-tab.js?v=049a422d';
import { initTankTab } from './tank-tab.js?v=049a422d';
import { initTank2Tab } from './tank2-tab.js?v=049a422d';
import { initTank3Tab } from './tank3-tab.js?v=049a422d';
import { initUnitsTab } from './units-tab.js?v=049a422d';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=049a422d';
import { initSimTab } from './sim-tab.js?v=049a422d';
import { initRecordTab } from './recordtab.js?v=049a422d';
