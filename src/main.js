...
import { wireDevlogBadge } from './devlog.js?v=e5aa98cb';
import { initHomeTab } from './home-tab.js?v=e5aa98cb';
import { initGridTab } from './grid-tab.js?v=e5aa98cb';
import { initMazeTab } from './maze-tab.js?v=e5aa98cb';
import { initOrganicTab } from './organic-tab.js?v=e5aa98cb';
import { initBattleTab } from './battle-tab.js?v=e5aa98cb';
import { initHeartTab } from './heart-tab.js?v=e5aa98cb';
import { initTdTab } from './td-tab.js?v=e5aa98cb';
import { initTankTab } from './tank-tab.js?v=e5aa98cb';
import { initTank2Tab } from './tank2-tab.js?v=e5aa98cb';
import { initTank3Tab } from './tank3-tab.js?v=e5aa98cb';
import { initUnitsTab } from './units-tab.js?v=e5aa98cb';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=e5aa98cb';
import { initSimTab } from './sim-tab.js?v=e5aa98cb';
import { initRecordTab } from './recordtab.js?v=e5aa98cb';
