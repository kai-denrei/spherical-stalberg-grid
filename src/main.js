...
import { wireDevlogBadge } from './devlog.js?v=83b5800a';
import { initGridTab } from './grid-tab.js?v=83b5800a';
import { initMazeTab } from './maze-tab.js?v=83b5800a';
import { initOrganicTab } from './organic-tab.js?v=83b5800a';
import { initBattleTab } from './battle-tab.js?v=83b5800a';
import { initHeartTab } from './heart-tab.js?v=83b5800a';
import { initTdTab } from './td-tab.js?v=83b5800a';
import { initHowTab } from './how-tab.js?v=83b5800a';
