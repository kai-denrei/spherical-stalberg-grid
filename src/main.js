...
import { wireDevlogBadge } from './devlog.js?v=ec1cf036';
import { initGridTab } from './grid-tab.js?v=ec1cf036';
import { initMazeTab } from './maze-tab.js?v=ec1cf036';
import { initOrganicTab } from './organic-tab.js?v=ec1cf036';
import { initBattleTab } from './battle-tab.js?v=ec1cf036';
import { initHeartTab } from './heart-tab.js?v=ec1cf036';
import { initTdTab } from './td-tab.js?v=ec1cf036';
import { initHowTab } from './how-tab.js?v=ec1cf036';
