...
import { wireDevlogBadge } from './devlog.js?v=f1b41625';
import { initGridTab } from './grid-tab.js?v=f1b41625';
import { initMazeTab } from './maze-tab.js?v=f1b41625';
import { initOrganicTab } from './organic-tab.js?v=f1b41625';
import { initBattleTab } from './battle-tab.js?v=f1b41625';
import { initHeartTab } from './heart-tab.js?v=f1b41625';
import { initTdTab } from './td-tab.js?v=f1b41625';
import { initTankTab } from './tank-tab.js?v=f1b41625';
import { initTank2Tab } from './tank2-tab.js?v=f1b41625';
import { initTank3Tab } from './tank3-tab.js?v=f1b41625';
import { initHowTab } from './how-tab.js?v=f1b41625';
