...
import { wireDevlogBadge } from './devlog.js?v=1611d20a';
import { initHomeTab } from './home-tab.js?v=1611d20a';
import { initGridTab } from './grid-tab.js?v=1611d20a';
import { initMazeTab } from './maze-tab.js?v=1611d20a';
import { initOrganicTab } from './organic-tab.js?v=1611d20a';
import { initBattleTab } from './battle-tab.js?v=1611d20a';
import { initHeartTab } from './heart-tab.js?v=1611d20a';
import { initTdTab } from './td-tab.js?v=1611d20a';
import { initTankTab } from './tank-tab.js?v=1611d20a';
import { initTank2Tab } from './tank2-tab.js?v=1611d20a';
import { initTank3Tab } from './tank3-tab.js?v=1611d20a';
import { initUnitsTab } from './units-tab.js?v=1611d20a';
import { initBeamTab } from './beam-tab.js?v=1611d20a';
import { initPortalTab } from './portal-tab.js?v=1611d20a';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=1611d20a';
import { initSimTab } from './sim-tab.js?v=1611d20a';
import { initRecordTab } from './recordtab.js?v=1611d20a';
