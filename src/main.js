...
import { wireDevlogBadge } from './devlog.js?v=d7f7f97b';
import { initGridTab } from './grid-tab.js?v=d7f7f97b';
import { initMazeTab } from './maze-tab.js?v=d7f7f97b';
import { initOrganicTab } from './organic-tab.js?v=d7f7f97b';
import { initBattleTab } from './battle-tab.js?v=d7f7f97b';
import { initHeartTab } from './heart-tab.js?v=d7f7f97b';
import { initTdTab } from './td-tab.js?v=d7f7f97b';
import { initTankTab } from './tank-tab.js?v=d7f7f97b';
import { initTank2Tab } from './tank2-tab.js?v=d7f7f97b';
import { initTank3Tab } from './tank3-tab.js?v=d7f7f97b';
import { initHowTab } from './how-tab.js?v=d7f7f97b';
