...
import { wireDevlogBadge } from './devlog.js?v=c13865b3';
import { initGridTab } from './grid-tab.js?v=c13865b3';
import { initMazeTab } from './maze-tab.js?v=c13865b3';
import { initOrganicTab } from './organic-tab.js?v=c13865b3';
import { initBattleTab } from './battle-tab.js?v=c13865b3';
import { initHeartTab } from './heart-tab.js?v=c13865b3';
import { initTdTab } from './td-tab.js?v=c13865b3';
import { initTankTab } from './tank-tab.js?v=c13865b3';
import { initTank2Tab } from './tank2-tab.js?v=c13865b3';
import { initTank3Tab } from './tank3-tab.js?v=c13865b3';
import { initHowTab } from './how-tab.js?v=c13865b3';
