...
import { wireDevlogBadge } from './devlog.js?v=5e01323b';
import { initHomeTab } from './home-tab.js?v=5e01323b';
import { initGridTab } from './grid-tab.js?v=5e01323b';
import { initMazeTab } from './maze-tab.js?v=5e01323b';
import { initOrganicTab } from './organic-tab.js?v=5e01323b';
import { initBattleTab } from './battle-tab.js?v=5e01323b';
import { initHeartTab } from './heart-tab.js?v=5e01323b';
import { initTdTab } from './td-tab.js?v=5e01323b';
import { initTankTab } from './tank-tab.js?v=5e01323b';
import { initTank2Tab } from './tank2-tab.js?v=5e01323b';
import { initTank3Tab } from './tank3-tab.js?v=5e01323b';
import { initUnitsTab } from './units-tab.js?v=5e01323b';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=5e01323b';
