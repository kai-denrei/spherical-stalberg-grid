...
import { wireDevlogBadge } from './devlog.js?v=679c9aa3';
import { initGridTab } from './grid-tab.js?v=679c9aa3';
import { initMazeTab } from './maze-tab.js?v=679c9aa3';
import { initOrganicTab } from './organic-tab.js?v=679c9aa3';
import { initBattleTab } from './battle-tab.js?v=679c9aa3';
import { initHeartTab } from './heart-tab.js?v=679c9aa3';
import { initHowTab } from './how-tab.js?v=679c9aa3';
