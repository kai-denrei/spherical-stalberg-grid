...
import { wireDevlogBadge } from './devlog.js?v=2018e2c5';
import { initHomeTab } from './home-tab.js?v=2018e2c5';
import { initGridTab } from './grid-tab.js?v=2018e2c5';
import { initMazeTab } from './maze-tab.js?v=2018e2c5';
import { initOrganicTab } from './organic-tab.js?v=2018e2c5';
import { initBattleTab } from './battle-tab.js?v=2018e2c5';
import { initHeartTab } from './heart-tab.js?v=2018e2c5';
import { initTdTab } from './td-tab.js?v=2018e2c5';
import { initTankTab } from './tank-tab.js?v=2018e2c5';
import { initTank2Tab } from './tank2-tab.js?v=2018e2c5';
import { initTank3Tab } from './tank3-tab.js?v=2018e2c5';
import { initUnitsTab } from './units-tab.js?v=2018e2c5';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=2018e2c5';
