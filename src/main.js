...
import { wireDevlogBadge } from './devlog.js?v=ade5ce2d';
import { initHomeTab } from './home-tab.js?v=ade5ce2d';
import { initGridTab } from './grid-tab.js?v=ade5ce2d';
import { initMazeTab } from './maze-tab.js?v=ade5ce2d';
import { initOrganicTab } from './organic-tab.js?v=ade5ce2d';
import { initBattleTab } from './battle-tab.js?v=ade5ce2d';
import { initHeartTab } from './heart-tab.js?v=ade5ce2d';
import { initTdTab } from './td-tab.js?v=ade5ce2d';
import { initTankTab } from './tank-tab.js?v=ade5ce2d';
import { initTank2Tab } from './tank2-tab.js?v=ade5ce2d';
import { initTank3Tab } from './tank3-tab.js?v=ade5ce2d';
import { initUnitsTab } from './units-tab.js?v=ade5ce2d';
import { initBeamTab } from './beam-tab.js?v=ade5ce2d';
import { initPortalTab } from './portal-tab.js?v=ade5ce2d';
import { initCineTab } from './cine-tab.js?v=ade5ce2d';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=ade5ce2d';
import { initSimTab } from './sim-tab.js?v=ade5ce2d';
import { initRecordTab } from './recordtab.js?v=ade5ce2d';
