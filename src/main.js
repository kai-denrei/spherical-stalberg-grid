...
import { wireDevlogBadge } from './devlog.js?v=5a399688';
import { initHomeTab } from './home-tab.js?v=5a399688';
import { initGridTab } from './grid-tab.js?v=5a399688';
import { initMazeTab } from './maze-tab.js?v=5a399688';
import { initOrganicTab } from './organic-tab.js?v=5a399688';
import { initBattleTab } from './battle-tab.js?v=5a399688';
import { initHeartTab } from './heart-tab.js?v=5a399688';
import { initTdTab } from './td-tab.js?v=5a399688';
import { initTankTab } from './tank-tab.js?v=5a399688';
import { initTank2Tab } from './tank2-tab.js?v=5a399688';
import { initTank3Tab } from './tank3-tab.js?v=5a399688';
import { initUnitsTab } from './units-tab.js?v=5a399688';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=5a399688';
import { initSimTab } from './sim-tab.js?v=5a399688';
import { initRecordTab } from './recordtab.js?v=5a399688';
