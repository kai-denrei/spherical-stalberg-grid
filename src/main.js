...
import { wireDevlogBadge } from './devlog.js?v=55149511';
import { initHomeTab } from './home-tab.js?v=55149511';
import { initGridTab } from './grid-tab.js?v=55149511';
import { initMazeTab } from './maze-tab.js?v=55149511';
import { initOrganicTab } from './organic-tab.js?v=55149511';
import { initBattleTab } from './battle-tab.js?v=55149511';
import { initHeartTab } from './heart-tab.js?v=55149511';
import { initTdTab } from './td-tab.js?v=55149511';
import { initTankTab } from './tank-tab.js?v=55149511';
import { initTank2Tab } from './tank2-tab.js?v=55149511';
import { initTank3Tab } from './tank3-tab.js?v=55149511';
import { initUnitsTab } from './units-tab.js?v=55149511';
import { initBeamTab } from './beam-tab.js?v=55149511';
import { initPortalTab } from './portal-tab.js?v=55149511';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=55149511';
import { initSimTab } from './sim-tab.js?v=55149511';
import { initRecordTab } from './recordtab.js?v=55149511';
