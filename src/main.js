...
import { wireDevlogBadge } from './devlog.js?v=c5cecc7f';
import { initGridTab } from './grid-tab.js?v=c5cecc7f';
import { initMazeTab } from './maze-tab.js?v=c5cecc7f';
import { initOrganicTab } from './organic-tab.js?v=c5cecc7f';
import { initBattleTab } from './battle-tab.js?v=c5cecc7f';
import { initHeartTab } from './heart-tab.js?v=c5cecc7f';
import { initTdTab } from './td-tab.js?v=c5cecc7f';
import { initTankTab } from './tank-tab.js?v=c5cecc7f';
import { initTank2Tab } from './tank2-tab.js?v=c5cecc7f';
import { initTank3Tab } from './tank3-tab.js?v=c5cecc7f';
import { initHowTab } from './how-tab.js?v=c5cecc7f';
