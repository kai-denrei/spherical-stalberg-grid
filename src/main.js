...
import { wireDevlogBadge } from './devlog.js?v=7059234a';
import { initHomeTab } from './home-tab.js?v=7059234a';
import { initGridTab } from './grid-tab.js?v=7059234a';
import { initMazeTab } from './maze-tab.js?v=7059234a';
import { initOrganicTab } from './organic-tab.js?v=7059234a';
import { initBattleTab } from './battle-tab.js?v=7059234a';
import { initHeartTab } from './heart-tab.js?v=7059234a';
import { initTdTab } from './td-tab.js?v=7059234a';
import { initTankTab } from './tank-tab.js?v=7059234a';
import { initTank2Tab } from './tank2-tab.js?v=7059234a';
import { initTank3Tab } from './tank3-tab.js?v=7059234a';
import { initUnitsTab } from './units-tab.js?v=7059234a';
import { initBeamTab } from './beam-tab.js?v=7059234a';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=7059234a';
import { initSimTab } from './sim-tab.js?v=7059234a';
import { initRecordTab } from './recordtab.js?v=7059234a';
