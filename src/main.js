...
import { wireDevlogBadge } from './devlog.js?v=7b01e05c';
import { initHomeTab } from './home-tab.js?v=7b01e05c';
import { initGridTab } from './grid-tab.js?v=7b01e05c';
import { initMazeTab } from './maze-tab.js?v=7b01e05c';
import { initOrganicTab } from './organic-tab.js?v=7b01e05c';
import { initBattleTab } from './battle-tab.js?v=7b01e05c';
import { initHeartTab } from './heart-tab.js?v=7b01e05c';
import { initTdTab } from './td-tab.js?v=7b01e05c';
import { initTankTab } from './tank-tab.js?v=7b01e05c';
import { initTank2Tab } from './tank2-tab.js?v=7b01e05c';
import { initTank3Tab } from './tank3-tab.js?v=7b01e05c';
import { initUnitsTab } from './units-tab.js?v=7b01e05c';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=7b01e05c';
