...
import { wireDevlogBadge } from './devlog.js?v=cda5f764';
import { initHomeTab } from './home-tab.js?v=cda5f764';
import { initGridTab } from './grid-tab.js?v=cda5f764';
import { initMazeTab } from './maze-tab.js?v=cda5f764';
import { initOrganicTab } from './organic-tab.js?v=cda5f764';
import { initBattleTab } from './battle-tab.js?v=cda5f764';
import { initHeartTab } from './heart-tab.js?v=cda5f764';
import { initTdTab } from './td-tab.js?v=cda5f764';
import { initTankTab } from './tank-tab.js?v=cda5f764';
import { initTank2Tab } from './tank2-tab.js?v=cda5f764';
import { initTank3Tab } from './tank3-tab.js?v=cda5f764';
import { initUnitsTab } from './units-tab.js?v=cda5f764';
import { initHowTab, initStackTab } from './how-tab.js?v=cda5f764';
