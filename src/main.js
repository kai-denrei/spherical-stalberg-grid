...
import { wireDevlogBadge } from './devlog.js?v=f511b2e8';
import { initHomeTab } from './home-tab.js?v=f511b2e8';
import { initGridTab } from './grid-tab.js?v=f511b2e8';
import { initMazeTab } from './maze-tab.js?v=f511b2e8';
import { initOrganicTab } from './organic-tab.js?v=f511b2e8';
import { initBattleTab } from './battle-tab.js?v=f511b2e8';
import { initHeartTab } from './heart-tab.js?v=f511b2e8';
import { initTdTab } from './td-tab.js?v=f511b2e8';
import { initTankTab } from './tank-tab.js?v=f511b2e8';
import { initTank2Tab } from './tank2-tab.js?v=f511b2e8';
import { initTank3Tab } from './tank3-tab.js?v=f511b2e8';
import { initUnitsTab } from './units-tab.js?v=f511b2e8';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=f511b2e8';
import { initSimTab } from './sim-tab.js?v=f511b2e8';
import { applyFontPack, DEFAULT_FONT, DEFAULT_SHOUT_FONT, TYPE_FEEL,
  makeTypeParams, clampTypeParams } from './fonts.js?v=f511b2e8';
