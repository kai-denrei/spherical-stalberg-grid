...
import { wireDevlogBadge } from './devlog.js?v=8cc88854';
import { initGridTab } from './grid-tab.js?v=8cc88854';
import { initMazeTab } from './maze-tab.js?v=8cc88854';
import { initOrganicTab } from './organic-tab.js?v=8cc88854';
import { initBattleTab } from './battle-tab.js?v=8cc88854';
import { initHeartTab } from './heart-tab.js?v=8cc88854';
import { initHowTab } from './how-tab.js?v=8cc88854';
