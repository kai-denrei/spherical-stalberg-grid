...
import { wireDevlogBadge } from './devlog.js?v=989e0b6d';
import { initHomeTab } from './home-tab.js?v=989e0b6d';
import { initGridTab } from './grid-tab.js?v=989e0b6d';
import { initMazeTab } from './maze-tab.js?v=989e0b6d';
import { initOrganicTab } from './organic-tab.js?v=989e0b6d';
import { initBattleTab } from './battle-tab.js?v=989e0b6d';
import { initHeartTab } from './heart-tab.js?v=989e0b6d';
import { initTdTab } from './td-tab.js?v=989e0b6d';
import { initTankTab } from './tank-tab.js?v=989e0b6d';
import { initTank2Tab } from './tank2-tab.js?v=989e0b6d';
import { initTank3Tab } from './tank3-tab.js?v=989e0b6d';
import { initUnitsTab } from './units-tab.js?v=989e0b6d';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=989e0b6d';
