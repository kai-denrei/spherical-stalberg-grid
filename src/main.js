...
import { wireDevlogBadge } from './devlog.js?v=4d76651a';
import { initHomeTab } from './home-tab.js?v=4d76651a';
import { initGridTab } from './grid-tab.js?v=4d76651a';
import { initMazeTab } from './maze-tab.js?v=4d76651a';
import { initOrganicTab } from './organic-tab.js?v=4d76651a';
import { initBattleTab } from './battle-tab.js?v=4d76651a';
import { initHeartTab } from './heart-tab.js?v=4d76651a';
import { initTdTab } from './td-tab.js?v=4d76651a';
import { initTankTab } from './tank-tab.js?v=4d76651a';
import { initTank2Tab } from './tank2-tab.js?v=4d76651a';
import { initTank3Tab } from './tank3-tab.js?v=4d76651a';
import { initUnitsTab } from './units-tab.js?v=4d76651a';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=4d76651a';
