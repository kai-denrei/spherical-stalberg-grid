...
import { wireDevlogBadge } from './devlog.js?v=dc0eb989';
import { initGridTab } from './grid-tab.js?v=dc0eb989';
import { initMazeTab } from './maze-tab.js?v=dc0eb989';
import { initOrganicTab } from './organic-tab.js?v=dc0eb989';
import { initBattleTab } from './battle-tab.js?v=dc0eb989';
import { initHeartTab } from './heart-tab.js?v=dc0eb989';
import { initTdTab } from './td-tab.js?v=dc0eb989';
import { initHowTab } from './how-tab.js?v=dc0eb989';
