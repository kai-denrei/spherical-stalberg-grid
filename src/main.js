...
import { wireDevlogBadge } from './devlog.js?v=5c50a953';
import { initGridTab } from './grid-tab.js?v=5c50a953';
import { initMazeTab } from './maze-tab.js?v=5c50a953';
import { initOrganicTab } from './organic-tab.js?v=5c50a953';
import { initBattleTab } from './battle-tab.js?v=5c50a953';
import { initHeartTab } from './heart-tab.js?v=5c50a953';
import { initTdTab } from './td-tab.js?v=5c50a953';
import { initTankTab } from './tank-tab.js?v=5c50a953';
import { initHowTab } from './how-tab.js?v=5c50a953';
