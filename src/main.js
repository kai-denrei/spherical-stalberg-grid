...
import { wireDevlogBadge } from './devlog.js?v=fc2e9b59';
import { initHomeTab } from './home-tab.js?v=fc2e9b59';
import { initGridTab } from './grid-tab.js?v=fc2e9b59';
import { initMazeTab } from './maze-tab.js?v=fc2e9b59';
import { initOrganicTab } from './organic-tab.js?v=fc2e9b59';
import { initBattleTab } from './battle-tab.js?v=fc2e9b59';
import { initHeartTab } from './heart-tab.js?v=fc2e9b59';
import { initTdTab } from './td-tab.js?v=fc2e9b59';
import { initTankTab } from './tank-tab.js?v=fc2e9b59';
import { initTank2Tab } from './tank2-tab.js?v=fc2e9b59';
import { initTank3Tab } from './tank3-tab.js?v=fc2e9b59';
import { initUnitsTab } from './units-tab.js?v=fc2e9b59';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=fc2e9b59';
import { initSimTab } from './sim-tab.js?v=fc2e9b59';
import { applyFontPack, DEFAULT_FONT, DEFAULT_SHOUT_FONT, TYPE_FEEL,
  makeTypeParams, clampTypeParams } from './fonts.js?v=fc2e9b59';
