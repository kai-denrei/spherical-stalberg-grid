...
import { wireDevlogBadge } from './devlog.js?v=d2d060e7';
import { initHomeTab } from './home-tab.js?v=d2d060e7';
import { initGridTab } from './grid-tab.js?v=d2d060e7';
import { initMazeTab } from './maze-tab.js?v=d2d060e7';
import { initOrganicTab } from './organic-tab.js?v=d2d060e7';
import { initBattleTab } from './battle-tab.js?v=d2d060e7';
import { initHeartTab } from './heart-tab.js?v=d2d060e7';
import { initTdTab } from './td-tab.js?v=d2d060e7';
import { initTankTab } from './tank-tab.js?v=d2d060e7';
import { initTank2Tab } from './tank2-tab.js?v=d2d060e7';
import { initTank3Tab } from './tank3-tab.js?v=d2d060e7';
import { initUnitsTab } from './units-tab.js?v=d2d060e7';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=d2d060e7';
