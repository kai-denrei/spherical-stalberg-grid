...
import { wireDevlogBadge } from './devlog.js?v=7bb4fe5a';
import { initGridTab } from './grid-tab.js?v=7bb4fe5a';
import { initMazeTab } from './maze-tab.js?v=7bb4fe5a';
import { initOrganicTab } from './organic-tab.js?v=7bb4fe5a';
import { initBattleTab } from './battle-tab.js?v=7bb4fe5a';
import { initHeartTab } from './heart-tab.js?v=7bb4fe5a';
import { initTdTab } from './td-tab.js?v=7bb4fe5a';
import { initHowTab } from './how-tab.js?v=7bb4fe5a';
