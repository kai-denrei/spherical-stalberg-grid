...
import { wireDevlogBadge } from './devlog.js?v=8e75c685';
import { initGridTab } from './grid-tab.js?v=8e75c685';
import { initMazeTab } from './maze-tab.js?v=8e75c685';
import { initOrganicTab } from './organic-tab.js?v=8e75c685';
import { initBattleTab } from './battle-tab.js?v=8e75c685';
import { initHeartTab } from './heart-tab.js?v=8e75c685';
import { initTdTab } from './td-tab.js?v=8e75c685';
import { initTankTab } from './tank-tab.js?v=8e75c685';
import { initTank2Tab } from './tank2-tab.js?v=8e75c685';
import { initTank3Tab } from './tank3-tab.js?v=8e75c685';
import { initHowTab } from './how-tab.js?v=8e75c685';
