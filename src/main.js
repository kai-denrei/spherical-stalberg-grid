...
import { wireDevlogBadge } from './devlog.js?v=71cddf4e';
import { initHomeTab } from './home-tab.js?v=71cddf4e';
import { initGridTab } from './grid-tab.js?v=71cddf4e';
import { initMazeTab } from './maze-tab.js?v=71cddf4e';
import { initOrganicTab } from './organic-tab.js?v=71cddf4e';
import { initBattleTab } from './battle-tab.js?v=71cddf4e';
import { initHeartTab } from './heart-tab.js?v=71cddf4e';
import { initTdTab } from './td-tab.js?v=71cddf4e';
import { initTankTab } from './tank-tab.js?v=71cddf4e';
import { initTank2Tab } from './tank2-tab.js?v=71cddf4e';
import { initTank3Tab } from './tank3-tab.js?v=71cddf4e';
import { initUnitsTab } from './units-tab.js?v=71cddf4e';
import { initBeamTab } from './beam-tab.js?v=71cddf4e';
import { initAstroTab } from './astro-tab.js?v=71cddf4e';
import { initMetalTab } from './metal-tab.js?v=71cddf4e';
import { initPortalTab } from './portal-tab.js?v=71cddf4e';
import { initCineTab } from './cine-tab.js?v=71cddf4e';
import { initHowTab, initStackTab, initLogTab } from './how-tab.js?v=71cddf4e';
import { initSimTab } from './sim-tab.js?v=71cddf4e';
import { initRecordTab } from './recordtab.js?v=71cddf4e';
