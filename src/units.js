...
import { printPhase, printOffset, printOn } from './printpath.js?v=aca2a327';
import { loadGlb, mergeByMaterial, fitModel, tintModel, makeShellRack,
  addEdgeOutlines, makeHeatSleeve } from './glbmodels.js?v=aca2a327';
import { CREATURES, waveJelly, swimWave, spherePts, bulletPts, missilePts, heartPts, torusPts, towerHeadPts, enemyDotPts, portalPts } from './creatures.js?v=aca2a327';
import { TOWER_FEEL, TOWER_HEADS, headKindFor } from './towerfeel.js?v=aca2a327';
import { STARGATE_PTS, STARGATE_STROKE,
  HORIZON_N, stargateHorizon } from './stargate.js?v=aca2a327';
import { ENEMY_SPEC } from './enemyspec.js?v=aca2a327';
