...
import { printPhase, printOffset, printOn } from './printpath.js?v=bae30d1e';
import { loadGlb, mergeByMaterial, fitModel, tintModel, makeShellRack,
  addEdgeOutlines, makeHeatSleeve } from './glbmodels.js?v=bae30d1e';
import { CREATURES, waveJelly, swimWave, spherePts, bulletPts, missilePts, heartPts, torusPts, towerHeadPts, enemyDotPts, portalPts } from './creatures.js?v=bae30d1e';
import { TOWER_FEEL, TOWER_HEADS, headKindFor } from './towerfeel.js?v=bae30d1e';
import { STARGATE_PTS, STARGATE_STROKE,
  HORIZON_N, stargateHorizon } from './stargate.js?v=bae30d1e';
import { ENEMY_SPEC } from './enemyspec.js?v=bae30d1e';
