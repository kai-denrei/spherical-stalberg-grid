...
export const LOOKS = {
  battlezone: {
    ...
    walls: { top: [0, 0, 0], side: [0.002, 0.014, 0.006] },
    jitter: 0,
    edges: { show: true, color: 0x54ff7a, opacity: 1.0, additive: false, wallTops: false },
  ...
  tron: {
    ...
    walls: { top: [0, 0, 0], side: [0.004, 0.007, 0.018] },
    jitter: 0,
    edges: { show: true, color: 0x00e5ff, opacity: 0.9, additive: true, wallTops: false },
