...
| 4 | **Polish + sound.** Film pass ✔ 2026-09-04 (`cine/film.js`: letterbox, grain, vignette, VT323 title card, in the canvas). Not done: TAA/SMAA on the live tier; the sound rail | three clips the operator would post |
